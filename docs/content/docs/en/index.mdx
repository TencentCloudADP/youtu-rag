...
Follow the instructions in [Deploying Youtu Embedding Locally](/docs/en/youtu-embedding/deploying_locally) or [Deploying Youtu Embedding with Docker](/docs/en/youtu-embedding/docker_image) to set up the Youtu Embedding service. Then add the following configuration to your `.env` file:
...
Follow the instructions in [Deploying HiChunk Locally](/docs/en/hichunk/deploying_locally) or [Deploying HiChunk with Docker](/docs/en/hichunk/docker_image) to set up the HiChunk service. Then add the following configuration to your `.env` file:
...
Follow the instructions in [Deploying Youtu Parsing Locally](/docs/en/youtu-parsing/deploying_locally) or [Deploying Youtu Parsing with Docker](/docs/en/youtu-parsing/docker_image) to set up the Youtu Parsing service. Then add the following configuration to your `.env` file:
