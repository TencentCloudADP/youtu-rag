...
const translations = {
  zh: {
    ...
    // Feature tags
    about_tag_vector_search: '向量检索',
    about_tag_sql_query: 'SQL查询',
    about_tag_metadata_filter: '元数据过滤',
    about_tag_short_term_memory: '短期记忆',
    about_tag_long_term_memory: '长期记忆',
    about_tag_qa_learning: 'QA学习',
    about_tag_structured_search: '结构化检索',
    about_tag_reading_comprehension: '阅读理解',
    about_tag_metadata_retrieval: '元数据检索',
  ...
  en: {
    ...
    // Feature tags
    about_tag_vector_search: 'Vector Search',
    about_tag_sql_query: 'SQL Query',
    about_tag_metadata_filter: 'Metadata Filter',
    ...
    about_tag_structured_search: 'Structured Search',
    about_tag_reading_comprehension: 'Reading Comprehension',
    about_tag_metadata_retrieval: 'Metadata Retrieval',
